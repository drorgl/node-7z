...
describe("Method: `Zip.extractFull`", () => {
	...
	it("should return an error on output duplicate", (done) => {
	...
	it("should extract only given wilcards", (done) => {
	...
	it("should work with spaces in archive name", (done) => {
	...
	it("should work with spaces in destination", (done) => {
	...
	it("should work with spaces in both source and destination", (done) => {
		/*jshint maxlen:false*/
